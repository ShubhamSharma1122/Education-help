...
import in.sp.main.servicesimp.EmployeeServiceImpl;
...
public class EmployeeController
{
	...
	public String sellCourseForm(@ModelAttribute("orders") Orders orders,
			@SessionAttribute("sessionEmp") Employee sessionEmp, RedirectAttributes redirectAttributes)
	{
		try {
			// 🔥 ONE LINE ONLY
			orders.setDateOfPurchase(LocalDateTime.now());
